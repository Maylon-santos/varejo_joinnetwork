...
export async function semearVisaoGeral(e){
 ...
 for(let i=1;i<=22;i++)await e.pool.query("INSERT INTO operacao_itens(cod_operacao,tipo_operacao,filial,ordem,sku,cod_produto,descricao,quantidade,preco_centavos,imagem_url) VALUES(100,'S',1,$1,$2,$3,$4,$5,1000,$6)",[i,'SKU-'+i,'P'+String(i).padStart(2,'0'),'Produto exemplo '+i,i===1?3:1,i===2?null:i===3?photo.replace('teste.png','ausente.png'):photo]);
